...
export default function SelectOptionsTags ( selectedCurrency){
    var retValue =``;
	rowData.forEach((data)=>{
		if(selectedCurrency===data.isoAlpha3){
			retValue += (`<option value=${data.currency.code} selected>${data.currency.code}</option>\n`);
		}else{
			retValue += (`<option value=${data.currency.code}>${data.currency.code}</option>\n`);
		}
